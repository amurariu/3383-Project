...
#LOOK OVER CODE FROM HERE ONWARDS
...
count_norm <- count_norm[matrixStats::rowVars(count_norm)>0, ]


results(count_norm)
# Estimation
#conditions_mat <- model.matrix(~ 1 + conds)[, 2, drop=FALSE] #line error

```


```{r}
DESeq2::plotMA(count_norm,alpha=0.01)
```
