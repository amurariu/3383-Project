...
# matrix of results
n.iter = 100
aldex.test.results.50.test2 <- matrix(data=NA, ncol=5, nrow=n.iter)
colnames(aldex.test.results.50.test2) <- c("size", "TP", "FP","sens","spec")
for(i in 1:100){
size = 50
sub.cond20 <- c(rep("H", size), rep("BV", size))
gam.sub20 <-  aldex.makeScaleMatrix(gamma=0.5, mu=c(0.15,0), conditions = sub.cond20 )
...
sen20 <- TP20/length(refTP20)
spec20 <- FP20/length(sub20.P)
aldex.test.results.50.test2[i,] <- c(size,TP20,FP20,sen20,spec20)
}
...
save(aldex.test.results.50.test2, file="output/aldex.mu0.15.50v2.Rda")
...
save(aldex.subw10,file="output/aldex.sub.w10")
...
save(aldex.test.results.w50, file="output/aldex.test.results.w50V2.Rda")
...
save(aldex.test.results.w50, file="output/aldex.test.results.w20V2.Rda")
